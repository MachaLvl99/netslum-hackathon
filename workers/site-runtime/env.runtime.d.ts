/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.runtime.jsonc env.runtime.d.ts` (hash: 6f09c5df61db6be3d03c89cde11856d1)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 
interface __BaseEnv_Env {
	DB: D1Database;
	PRODUCTION_DISPATCHER: DispatchNamespace;
	SITE_RATE: RateLimit;
	SITE_RUNTIME_ORIGIN: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/dispatcher");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_RUNTIME_ORIGIN">> {}
}
