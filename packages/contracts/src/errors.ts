export const errorCodes = [
  ...
  // Phase 2 (plan §G)
  "REAUTHORIZE_REQUIRED", "CAPABILITY_UNAVAILABLE", "CHAT_UNAVAILABLE",
  "VIDEO_UNAVAILABLE", "MEDIA_PROCESSING", "MEDIA_FAILED",
  "PREVIEW_EXPIRED", "INVALID_TOOL_MANIFEST", "TOOL_RUNTIME_FAILED"
] as const;
